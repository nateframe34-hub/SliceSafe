# SliceSafe Pro — Batches 8–12 Enhanced Creative Briefs
### 15 Creatives with Origins Frameworks, Nano Banana Pro Prompts & Canva Step-by-Steps
### Date: Feb 28, 2026
### Companion to: `SliceSafe-Pro-Week3-Creative-Briefs.md` (Batches 6–13) + `SliceSafe-Pro-Avatar-Strategy.md` (core strategy)

---

## What This Document Is

This is the **enhanced execution brief** for Batches 8–12. The original Week 3 brief (`SliceSafe-Pro-Week3-Creative-Briefs.md`) contains these batches, but this document upgrades every creative with:

1. **Origins framework annotations** — SHOW vs TELL, Self-categorization, FRAMES, Template alignment
2. **Swipe file pattern cross-references** — Exact pattern + priority ranking from the Swipe Feedback Loop
3. **Marketing psychology principles** — Named cognitive biases powering each creative's hook
4. **Enhanced Nano Banana Pro prompts** — More detailed, mood-specific, with composition notes
5. **Enhanced Canva step-by-steps** — Exact hex colors, px sizes, positioning percentages
6. **Body copy with Origins analysis** — Every copy block annotated with framework + mechanism version

**Use this document for production.** The Week 3 brief remains the strategic overview.
...
| Skill | Application |
|-------|------------|
| **paid-ads** | Campaign structure, audience targeting by sub-avatar, platform optimization |
| **ad-creative** | Nano Banana Pro prompts, Meta ad specs (1080x1350, 4:5), angle categories, creative testing hierarchy |
| **marketing-psychology** | 20+ mental models applied: Loss Aversion, Contrast Effect, Anchoring, Status-Quo Bias, Availability Heuristic, Unity Principle, Present Bias, Regret Aversion, Mimetic Desire, Endowment Effect, Pratfall Effect, Completion Bias, Confirmation Bias, Mere Exposure, Temporal Framing, Category Reframe, Identity Gap, Sunk Cost reframe |
| **copywriting** | PAS (Problem-Agitate-Solve), Before-After-Bridge, Social Proof Lead frameworks; clarity over cleverness; specificity over vagueness; customer language over company language |
| **nano-banana-pro-prompts** | Detailed image generation prompts with lighting, mood, composition, and aspect ratio specs |

---

## Psychology Cross-Reference by Batch
...
| Format | Batches | Image Gen Needed | Canva Only | Swipe Pattern |
|--------|---------|:----------------:|:----------:|---------------|
...
## Production Rules (Unchanged from Week 3)
...
### Visual Audit Rules (from Swipe File Analysis):
- **Hook size:** 2-6 words at 48px+ Bold for image-led. Full sentences OK at 38-44px+ Bold for concept hooks.
- **Dark backgrounds:** All text must be Bold weight minimum for readability
- **Feed camouflage:** NO price tag, NO brand pill, caption bar only
- **Cover test:** Cover the text — does the image still sell? If not, the image is too weak.

### Naming Convention:
`B[batch]_[theme]_[angle-short]`

---

## Iteration Log

- **Round:** Enhanced v1 (replaces Week 3 Batches 8–12 sections)
- **Date:** Feb 28, 2026
- **Changes from Week 3 original:**
  - Added Origins framework annotations to every creative
  - Added SHOW vs TELL analysis to every body copy
  - Added self-categorization fixes (removed "mandoline" from hooks where it triggers fear association)
  - Added mechanism version labels (A = Physical/Spatial, B = Experience, C = Comparison)
  - Enhanced Canva step-by-steps with exact hex colors and positioning percentages
  - Added final checklists per creative
- **Angles being tested:** Category reframe, food outcome, self-blame removal, stat-led, guard elimination, avatar call-out, identity gap, aspiration, meme, strikethrough, drawer guilt
- **New formats introduced:** 6 Canva-only + 7 image-gen formats across 13 distinct visual approaches
